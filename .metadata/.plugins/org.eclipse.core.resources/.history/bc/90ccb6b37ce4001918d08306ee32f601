...
public class Fornecedor {
	...
	public void cadastraProduto(String preco, String nome, String descricao) {
		produtos.add(new Produto(preco, nome, descricao));
	}
	
	private Produto buscaProduto(String nomeProduto, String descricao) {
		Produto p1 = null;
	...
	public String exibirProduto(String nomeProduto, String descricao) {
		return buscaProduto(nomeProduto, descricao).toString();
	}
	...
	public void mudarPreco(String nomeProduto, String descricao, String precoNovo) {
		buscaProduto(nomeProduto, descricao).setPreco(precoNovo);
	}
	
	public void removeProduto(String nomeProduto, String descricao) {
		produtos.remove(buscaProduto(nomeProduto, descricao));
	}
}
