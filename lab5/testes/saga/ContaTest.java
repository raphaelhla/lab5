...
class ContaTest {
	...
	public void testAdicionaContaNomeProdutoNulo() {
		try {
			c1.adicionaCompra("Raphael", "Josenilda", null, "Tapioca com frango", "10/12/2019", 10.0);;
			fail("Deveria lancar excecao");
		} catch (NullPointerException e) {
	...
	public void testAdicionaContaNomeProdutoVazio() {
		try {
			c1.adicionaCompra("Raphael", "Josenilda", "", "Tapioca com frango", "10/12/2019", 10.0);;
			fail("Deveria lancar excecao");
		} catch (IllegalArgumentException e) {
			assertEquals("Erro ao cadastrar compra: nome do produto nao pode ser vazio ou nulo.", e.getMessage());
		}
	...
	public void testAdicionaContaDataVazia() {
		try {
			c1.adicionaCompra("Raphael", "Josenilda", "Tapioca", "Tapioca com frango", "", 10.0);;
			fail("Deveria lancar excecao");
		} catch (IllegalArgumentException e) {
	...
	public void testAdicionaContaDataNula() {
		try {
			c1.adicionaCompra("Raphael", "Josenilda", "Tapioca", "Tapioca com frango", null, 10.0);;
			fail("Deveria lancar excecao");
		} catch (NullPointerException e) {
			assertEquals("Erro ao cadastrar compra: data nao pode ser vazia ou nula.", e.getMessage());
		}
	...
	public void testAdicionaContaDataInvalida() {
		try {
			c1.adicionaCompra("Raphael", "Josenilda", "Tapioca", "Tapioca com frango", "10/1000/20000", 10.0);
			fail("Deveria lancar excecao");
		} catch (IllegalArgumentException e) {
	...
	public void testToString() {
		c2.adicionaCompra("Raphael", "Josenilda", "Tapioca", "Tapioca com frango", "10/10/2019", 10.0);
		c2.adicionaCompra("Raphael", "Josenilda", "Suco", "Suco de maracuja", "19/10/2019", 8.0);
	...
	public void testCompareTo() {
		...
		contas.add(c2);
		contas.add(c1);
		c1.adicionaCompra("Raphael", "Josenilda", "Tapioca", "Tapioca com frango", "10/10/2019", 10.0);
		c2.adicionaCompra("Raphael", "Josenilda", "Suco", "Suco de maracuja", "19/10/2019", 8.0);
